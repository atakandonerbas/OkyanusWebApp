<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YoneticiGiris.aspx.cs" Inherits="OkyanusWebApp.YoneticiPanel.YoneticiGiris" %>
...
<body>
    <form id="form1" runat="server">
        <div class="girisPanel">
            <div class="ust">
                <img src="SiteResimleri/okyanus_logo.png" />
            </div>
            <div class="alt">
                <div class="satir">
